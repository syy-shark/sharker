 ...
 * or `npm --workspace @sharker/desktop run smoke:browser`). It drives the
...
<html>
  <head><meta charset="utf-8"><title>Sharker Smoke</title></head>
  <body>
    <h1>Sharker observe-to-act smoke</h1>
...
async function runSmoke() {
  ...
  try {
    ...
    const partition = session.fromPartition('persist:sharker-browser');
