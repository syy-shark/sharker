...
import { ICON_SIZE, Check, ChevronRight, Search } from '@sharker/ui/icons';
import {
  CATALOG_PROVIDER_TYPES,
  RECOMMENDED_PROVIDER_TYPES,
  type ProviderCatalogGroup,
  type ProviderType,
} from '@sharker/core/provider-registry';
import { PROVIDER_DEFAULTS } from '@sharker/core/llm-connections';
import { Button, TextInput, useUiLocale } from '@sharker/ui';
...
export function ProviderCatalogPage(props: {
  ...
  return (
    <VStack gap={4} data-sharker-contract="provider-catalog">
...
export function ProviderSetupPage(props: {
  ...
  if (props.target.method === 'account') {
    return (
      <div tabIndex={-1} className="settingsRouteLevel" data-sharker-contract="provider-setup">
