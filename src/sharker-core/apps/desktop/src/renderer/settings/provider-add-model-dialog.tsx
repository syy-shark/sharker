...
import { Button, HStack, NumberInput, TextInput, useUiLocale } from '@sharker/ui';
 ...
 * context window is the one fact nothing else can supply: an id Sharker has never
 ...
 * the model list, which shows a row for exactly the models Sharker cannot
  ...
  return (
    ...
    >
      <Layout
        ...
        content={
          <LayoutContent>
            <form id="sharker-add-model-form" onSubmit={(event) => void submit(event)}>
              <FormLayout>
