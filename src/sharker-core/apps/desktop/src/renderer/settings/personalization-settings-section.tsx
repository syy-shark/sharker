...
// The 身份 group of the 通用 page: how Sharker addresses you, the interface
...
import type { AppSettings, PersonalizationSettings, UpdateAppSettingsResult } from '@sharker/core/settings';
import type { UiLocalePreference } from '@sharker/core/ui-locale';
import { TextArea, TextInput, useMountedRef, useToast, useUiLocale } from '@sharker/ui';
