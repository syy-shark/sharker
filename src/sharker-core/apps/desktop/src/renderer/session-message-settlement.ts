...
export type TranscriptSettlementSource = Pick<SharkerBridge['transcripts'], 'open'>;
...
export async function readSettledMessages(
  ...
  return readSettledMessagesUsing(window.sharker.transcripts, sessionId, options);
}
