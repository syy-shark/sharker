...
import { Button, Composer, SandboxBoundaryPrompt, UserQuestionPrompt, Banner } from '@sharker/ui';
import type { ComposerHandle, ComposerInteraction } from '@sharker/ui';
...
export function ChatComposerRegion({
  ...
  return (
    <>
      <div className="sharker-composer-interaction-slot">
        ...
        {boundaryUnreadableNotice && active && !activeInteraction && (
          <div className="sharker-boundary-unreadable-notice">
            <Banner
              status="warning"
              className="sharker-boundary-unreadable-notice-alert"
              role="status"
