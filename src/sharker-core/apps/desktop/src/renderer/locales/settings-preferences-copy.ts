 ...
 * under the License.
 */
import type { AppIcon, ThemePalette, ThemePreference } from '@sharker/core/settings';
import type { UiCatalog, UiLocale, UiLocalePreference } from '@sharker/core/ui-locale';
...
const SETTINGS_PREFERENCES_COPY_BY_LOCALE = {
  zh: {
    ...
    pets: {
      ...
      importErrors: { invalid_directory: '所选文件夹无效。', invalid_manifest: 'pet.json 不符合 sharker.pet/v1 格式。', invalid_asset: '精灵图缺失、无效或超出限制。', already_installed: '已经导入了相同 ID 的宠物。', read_failed: '无法读取所选文件夹。' },
