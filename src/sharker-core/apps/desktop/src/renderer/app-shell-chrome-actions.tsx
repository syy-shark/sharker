  ...
  return (
    <Tooltip content={label}>
      <IconButton
        ...
        className={
          props.className
            ? `sharker-titlebar-action ${props.className}`
            : 'sharker-titlebar-action'
        }
...
export function AppShellTopbarActions(props: {
  ...
  return (
    <div className="sharker-shell-topbar-rail" data-sharker-contract="shell-topbar-rail" role="group" aria-label={copy.windowActions}>
      <Tooltip content={copy.searchConversations}>
        <IconButton
          ...
          data-sharker-search-trigger="true"
 ...
 * platform's native window controls are: `.sharker-window-titlebar` reserves
