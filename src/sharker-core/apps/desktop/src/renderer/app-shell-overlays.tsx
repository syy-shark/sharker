...
import type { ChatDefaultPermissionMode, SettingsSection, ThemePalette, ThemePreference } from '@sharker/core/settings';
...
import { SearchModal, useUiLocale } from '@sharker/ui';
...
const SettingsModal = lazy(async () => {
  const e2eLatch = (
    window as typeof window & {
      sharkerE2eLatch?: { wait(key: 'settings.chunk'): Promise<void> };
    }
  ).sharkerE2eLatch;
...
function SettingsModalFallback() {
  ...
  return (
    <div
      ...
      data-agents-page
    >
      <div className="sharker-lazy-fallback" data-surface="modal">
