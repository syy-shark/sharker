...
import type { PeerMeshProjection, PeerMeshQueryResult } from '@sharker/runtime-host/protocol';
import {
  Badge,
  Button,
  MoreMenu,
...
function isInvitationResult(
  value: unknown,
): value is import('@sharker/runtime-host/protocol').PeerMeshInvitationResult {
  return Boolean(
    value &&
    typeof value === 'object' &&
    'invitation' in value &&
