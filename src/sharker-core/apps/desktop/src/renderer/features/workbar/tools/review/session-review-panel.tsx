...
import { redactSecrets as displayRedactSecrets } from '@sharker/core/display-redaction';
import { generalizedErrorMessage, generalizedErrorMessageChinese } from '@sharker/core/redaction';
import { type GitReviewReadResult } from '@sharker/core/git-review';
import { DiffCodePreview, useUiLocale } from '@sharker/ui';
import { ICON_SIZE, GitBranch } from '@sharker/ui/icons';
...
export function SessionReviewPanel(props: {
  ...
  return (
    <Section
      variant="transparent"
      padding={4}
      className="sharker-session-review-panel"
      role="region"
      ...
      <VStack gap={3} align="stretch" width="100%">
        {loading && gitResult === null ? (
          ...
          >
            ...
            <div className="sharker-session-review-loading-list">
        ...
        {gitSnapshot && gitFiles.length > 0 ? (
          <VStack gap={1} align="start" className="sharker-session-review-summary">
            <Text type="label">{copy.changedFiles(stats.files)}</Text>
            <HStack gap={3} align="center">
              <Text
                type="supporting"
                hasTabularNumbers
                className="sharker-session-review-additions"
              >
              ...
              <Text
                type="supporting"
                hasTabularNumbers
                className="sharker-session-review-deletions"
              >
        ...
        {gitFiles.length > 0 ? (
          <div className="sharker-session-review-list">
            <CollapsibleGroup
              ...
              {visibleGitFiles.map((file) => {
                ...
                return (
                  <Collapsible
                    ...
                    value={file.path}
                    className="sharker-session-review-file"
                    role="listitem"
                    trigger={
                      <HStack
                        as="span"
                        ...
                        justify="between"
                        width="100%"
                        className="sharker-session-review-file-trigger"
                      >
                        <Text
                          type="code"
                          maxLines={1}
                          className="sharker-session-review-file-path"
                        >
                          {file.path}
                        </Text>
                        <HStack
                          ...
                          gap={2}
                          align="center"
                          className="sharker-session-review-file-stats"
                        >
                          {file.additions > 0 ? (
                            <Text
                              type="supporting"
                  ...
                  >
                    <DiffCodePreview
                      diff={preview.body}
                      paths={[file.path]}
                      className="sharker-session-review-diff"
                    />
            ...
            {remainingGitFiles > 0 ? (
              <div className="sharker-session-review-more">
                <Button
                  variant="ghost"
                  size="sm"
