...
import { IconButton, useUiLocale } from '@sharker/ui';
import { Maximize2, Minimize2, PanelRightClose, PanelRightOpen } from '@sharker/ui/icons';
...
export function WorkbarTitlebarActions(props: {
  ...
  return (
    <div
      className="sharker-workspace-top-actions"
      role="toolbar"
