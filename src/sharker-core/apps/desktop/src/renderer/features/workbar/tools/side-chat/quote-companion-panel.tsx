...
export function QuoteCompanionPanel(props: {
  ...
  return (
    <div
      className="sharker-quote-companion"
    ...
    >
      ...
      >
        <ChatView
          ...
          emptyOverride={
            companion.preparing ? (
              <div className="sharker-quote-companion-preparing sharker-turn-processing">
                <Spinner size="sm" shade="subtle" label={copy.preparing} />
              </div>
            ) : (
              <div className="sharker-quote-companion-empty" aria-hidden="true" />
            )
          }
          onNew={() => {}}
        />
