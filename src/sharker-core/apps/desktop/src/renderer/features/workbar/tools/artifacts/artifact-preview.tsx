 ...
 * and renders:
 *
 *   - `file`  → bounded Astryx code or Sharker Markdown preview
...
function TextFilePreview(props: { name: string; text: string; copy: ArtifactCopy }) {
  ...
  return (
    <div className="sharker-artifact-preview-text" data-mode={mode}>
      {markdown && (
        <div className="sharker-artifact-preview-mode-switch" role="group" aria-label={props.copy.pane.previewNamed(props.name)}>
          <Button
      ...
      {mode === 'rendered' ? (
        <div className="sharker-artifact-preview-markdown">
...
function DiffPreview(props: { record: ArtifactDescriptor; copy: ArtifactCopy }) {
  ...
  return (
    <div className="sharker-artifact-preview-diff" data-kind="file_diff">
      <DiffCodePreview diff={rendered.highlightedText} paths={[props.record.name]} />
      {rendered.plainRemainder && <pre className="sharker-artifact-preview-plain-remainder sharker-code">{rendered.plainRemainder}</pre>}
...
function HtmlPreview(props: { record: ArtifactDescriptor; copy: ArtifactCopy }) {
  ...
  if (bounded.isDisplayTruncated) {
    return (
      <div className="sharker-artifact-preview-text">
  ...
  return (
    <div className="sharker-artifact-preview-html">
      <div
        className="sharker-artifact-preview-external-links-bar"
      ...
      <iframe
        className="sharker-artifact-preview-html-iframe"
...
function BoundedCodePreview(props: { name: string; bounded: BoundedPreviewText }) {
  ...
  return (
    <>
      <CodeBlock
        className="sharker-artifact-preview-code"
      ...
      {props.bounded.plainRemainder && (
        <pre className="sharker-artifact-preview-plain-remainder sharker-code">{props.bounded.plainRemainder}</pre>
      )}
    </>
  );
}
...
function PreviewLimitNote(props: { children: string }) {
  return <p className="sharker-artifact-preview-limit" role="note">{props.children}</p>;
}
...
function PdfPreview(props: { record: ArtifactDescriptor; copy: ArtifactCopy }) {
  ...
  return (
    <div className="sharker-artifact-preview-pdf">
      <embed
        ...
        height="100%"
      />
      <p className="sharker-artifact-preview-pdf-fallback">
...
function PreviewLoading(props: { label: string }) {
  return (
    <div className="sharker-artifact-preview-loading" role="status" aria-live="polite">
      <Spinner
        className="sharker-artifact-preview-spinner"
        size="sm"
        aria-hidden="true"
        role="presentation"
      />
...
function FailureCard(props: {
  ...
  return (
    <Banner
      className="sharker-artifact-preview-fail"
