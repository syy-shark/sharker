...
import { ICON_SIZE, Terminal as TerminalIcon } from '@sharker/ui/icons';
...
export function SessionTerminalPanel(props: {
  ...
  return (
    <div
      className="sharker-session-terminal-panel"
      role="region"
    ...
    >
      ...
      <div
        ref={hostRef}
        className="sharker-session-terminal-xterm"
        data-sharker-contract="session-terminal-xterm"
      />
    </div>
  );
}
