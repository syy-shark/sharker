...
import type { ArtifactDescriptor } from '@sharker/core/artifacts';
import { Button, useUiLocale } from '@sharker/ui';
...
import {
  ...
  formatPreviewSize,
  resolvePreviewKind,
} from '@sharker/ui/artifact-preview-registry';
...
export function UnsupportedArtifactPreview(props: {
  ...
  return (
    <Banner
      className="sharker-artifact-preview-unsupported"
      ...
      description={(
        <>
          <p className="sharker-artifact-preview-unsupported-body">{copy.description}</p>
          <dl className="sharker-artifact-preview-unsupported-meta">
            <div>
      ...
      endContent={props.onShowInFolder ? (
        <Button
          variant="secondary"
          className="sharker-artifact-preview-unsupported-cta"
...
function ImageArtifactPreview(props: {
  ...
  return (
    <div className="sharker-artifact-preview-image">
      <img
