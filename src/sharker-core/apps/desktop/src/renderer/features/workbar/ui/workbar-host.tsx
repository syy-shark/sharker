...
import { Composer, useUiLocale } from '@sharker/ui';
import type { ChatModelChoice } from '@sharker/core/chat-model-choice';
  ...
  return (
    <div className="sharker-workbar-workspace-contents">
      {placements.map((placement) => (
        ...
        >
          <div className="sharker-lazy-fallback" data-surface="panel">
...
export function WorkbarHost({ model: props }: { model: WorkbarHostModel }) {
  const copy = getShellCopy(useUiLocale()).app;
  const style = {
    '--sharker-session-workbar-width': `${props.rightWidth}px`,
    '--sharker-session-bottom-panel-height': `${props.bottomHeight}px`,
  } as CSSProperties;
  ...
  return (
    <>
      {props.activeId && !props.rightCollapsed && !props.rightExpanded && (
        <ResizeHandle
          className="sharker-workbar-resize-handle sharker-workbar-resize-handle-right"
      ...
      {props.activeId && props.bottomOpen && (
        <ResizeHandle
          className="sharker-workbar-resize-handle sharker-workbar-resize-handle-bottom"
      ...
      {props.activeId && (
        <div className="sharker-workbar-layout-vars" style={style}>
          <Suspense
            fallback={
