...
export function readSessionWorkbarWidth(): number {
  const stored = Number(safeLocalStorageGet('sharker-session-workbar-width-v1'));
...
export function readSessionWorkbarCollapsed(): boolean {
  const stored = safeLocalStorageGet('sharker-session-workbar-collapsed-v1');
...
export function readSessionBottomPanelHeight(): number {
  const stored = Number(safeLocalStorageGet('sharker-session-bottom-panel-height-v1'));
...
export function readSessionBottomPanelOpen(): boolean {
  return safeLocalStorageGet('sharker-session-bottom-panel-open-v1') === 'true';
}
