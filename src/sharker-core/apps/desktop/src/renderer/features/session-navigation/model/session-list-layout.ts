...
const SESSION_LIST_VIEW_MODE_KEY = 'sharker-chat-list-view-mode-v1';
...
export function readSessionListWidth(): number {
  const stored = Number(safeLocalStorageGet('sharker-chat-list-width-v1'));
...
export function readSessionListCollapsed(): boolean {
  const stored = safeLocalStorageGet('sharker-chat-list-collapsed-v1');
