...
import { ICON_SIZE, Keyboard } from '@sharker/ui/icons';
      ...
      <Layout
        ...
        content={
          <LayoutContent padding={0}>
            <div className="sharker-help-body">
          {copy.sections.map((section) => (
            <section key={section.heading} className="sharker-help-section">
                    ...
                    <dd>
                      {row.keys.map((key, index) => (
                        <span key={`${row.description}:${key}:${index}`}>
                          {index > 0 && (
                            <span className="sharker-help-plus" aria-hidden="true">
                              +
                            </span>
                          )}
