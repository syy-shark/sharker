    ...
    <AstryxLocaleProvider overrides={astryxOverrides}>
      <AstryxCommandPalette
        ...
        emptySearchText={(
          ...
          <EmptyState
            role="presentation"
            className="sharker-palette-empty"
        ...
        renderItem={(item) => {
          ...
          return (
            <>
              <span className="sharker-palette-icon" aria-hidden="true">
                <command.Icon size={ICON_SIZE.chrome} />
              </span>
              <span className="sharker-palette-label">{command.label}</span>
              {command.hint ? (
                <span className="sharker-palette-hint">
                  {command.hint}
                  <ChevronRight size={ICON_SIZE.meta} aria-hidden="true" />
                </span>
              ) : (
                <span className="sharker-palette-hint sharker-palette-cursor" aria-hidden="true">
        ...
        footer={(
          <CommandPaletteFooter>
            <span className="sharker-palette-footer-hint">
              <Kbd keys="up" />
              <Kbd keys="down" />
