...
import type { ConnectionTestResult } from '@sharker/core/llm-connections';
import type { TextFileImportPreflightFailureReason } from '@sharker/core/text-file-import';
...
const SESSION_READ_MESSAGES_ERROR_MARKER = 'SHARKER_SESSION_READ_MESSAGES_ERROR:';
