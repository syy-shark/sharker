 ...
 * into copy, is NOT here — both live in `@sharker/ui`'s file of the same name,
...
import { SANDBOX_BOUNDARY_RESTART_CLOSURE_CLASS } from '@sharker/core/sandbox-boundary';
import type { SessionBlockedReason, SessionSummary } from '@sharker/core/session';
 ...
 * Mirrors `describeBlockedReason()` in `@sharker/ui`, under the same rule: a UI
