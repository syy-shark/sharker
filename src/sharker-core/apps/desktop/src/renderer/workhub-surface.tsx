...
import { ChatSurfaceLayout, Composer } from '@sharker/ui';
import type {
  WorkHubController,
...
export function WorkHubSurface(props: {
  ...
  return (
    ...
    >
      <section className="sharker-main agents-chat-panel agents-chat-view-root workhub-timeline" aria-label="WorkHub">
        ...
        <div className="sharker-chat-shell">
          <ChatMessageList
            className="sharker-chat-message-list sharker-chatContent workhub-message-list"
            density="compact"
            gap={4}
            isStreaming={pending}
          >
...
export function WorkHubCoordinationStatus(props: {
  ...
  return (
    ...
    >
      <section
        className="sharker-main agents-chat-panel agents-chat-view-root workhub-timeline"
        aria-label="WorkHub"
      >
        <header className="workhub-header">
          <div>
  ...
  return (
    ...
    >
      <ChatMessage sender="user" density="compact" className="workhub-message">
        <ChatMessageBubble className="sharker-chat-message-bubble sharker-chat-message-bubble-user workhub-user-bubble">
          <p>{props.text}</p>
        </ChatMessageBubble>
      </ChatMessage>
      <ChatMessage sender="assistant" density="compact" className="workhub-message">
        <ChatMessageBubble
          variant="ghost"
          width="100%"
          className="sharker-chat-message-bubble sharker-chat-message-bubble-assistant workhub-assistant-bubble"
        >
          {props.children}
        </ChatMessageBubble>
      </ChatMessage>
