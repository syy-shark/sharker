...
/**
 * Cursor overlay window (main-process half) — the Sharker-owned, Codex-style agent
...
import type { CuPresentationFence } from '@sharker/runtime/computer-use-types';
...
// Shared cursor-move contract lives in @sharker/computer-use so the CLI can drive the
...
export type { CursorMoveInput } from '@sharker/computer-use';
import type {
  CursorCancelInput,
  CursorCompleteInput,
  CursorMoveInput,
