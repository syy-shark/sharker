...
import { resolveSystemUiLocale, type UiCatalog, type UiLocale } from '@sharker/core/ui-locale';
...
export function createComputerUseStatusItem(
  ...
  const load =
    ...
    ((): Electron.NativeImage => {
      ...
      // Carrying Sharker's cursor blue keeps them distinguishable at a glance, and
