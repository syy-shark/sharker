...
} from '@sharker/storage/operational-state-store';
import { projectSessionCatalogMessages } from '@sharker/storage/session-store';
...
export const PROMPT_RAIL_PROMPT_COUNT = process.env.SHARKER_TRANSCRIPT_STRESS === '1'
  ? 640
  : 120;
