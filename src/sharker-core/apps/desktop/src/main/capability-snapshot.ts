...
import { BOT_PROVIDERS, type BotProvider } from '@sharker/core/bot-chat-settings';
import {
...
} from '@sharker/core/capabilities';
import { type AppSettings } from '@sharker/core/settings';
import type { CuBackendId } from '@sharker/computer-use';
import type { BotStatus } from '@sharker/runtime/bots';
