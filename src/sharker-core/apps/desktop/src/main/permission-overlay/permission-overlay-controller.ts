...
import type { DragGrantPermissionId } from '@sharker/core/capabilities';
import { isDragGrantPermissionId } from '@sharker/core/capabilities';

// The id list lives in @sharker/core so the Permission Center row and this
