 ...
 *
 *   /Applications/Sharker.app/Contents/MacOS/Sharker   <- app.getPath('exe')
 *   /Applications/Sharker.app/Contents/MacOS
 *   /Applications/Sharker.app/Contents
 *   /Applications/Sharker.app                       <- what we drag
 *
 * Under `SHARKER_DEV_TCC=1` the same walk lands on the generated, signed
 * `Sharker Dev.app`, which is also the TCC identity the user grants. Under a plain
