...
import { resolveProjectGitInfo } from '@sharker/runtime/system-prompt/project-context';
 ...
 *  uses client-side (kept local so the main process doesn't import @sharker/ui). */
