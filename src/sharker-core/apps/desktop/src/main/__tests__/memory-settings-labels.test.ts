...
test('shortens Memory paths with their native separator', () => {
  assert.equal(
    displayMemoryPath('/Users/alice/.sharker/memory/MEMORY.md'),
    '…/.sharker/memory/MEMORY.md',
  );
  assert.equal(
    displayMemoryPath('C:\\Users\\alice\\.sharker\\memory\\MEMORY.md'),
    '…\\.sharker\\memory\\MEMORY.md',
  );
  assert.equal(
    displayMemoryPath('\\\\server\\share\\.sharker\\memory\\MEMORY.md'),
    '…\\.sharker\\memory\\MEMORY.md',
  );
});
