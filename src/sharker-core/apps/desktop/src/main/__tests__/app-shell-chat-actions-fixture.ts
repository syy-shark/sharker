...
import type { LiveTurnProjection, TransientUserMessageProjection } from '@sharker/ui';

/** Installs a `window.sharker` bridge double; the returned function restores it. */
export function installWindow(sharker: unknown): () => void {
