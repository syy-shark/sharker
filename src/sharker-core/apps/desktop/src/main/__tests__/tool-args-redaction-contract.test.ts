...
import { formatRedactedJson, formatToolIntent } from '@sharker/ui';
import { formatToolInvocationLine, projectToolArgsPreview } from '@sharker/core/tool-quiet-preview';
...
describe('tool args redaction', () => {
  ...
  it('keeps secrets out of the collapsed-row invocation line and its wire preview', () => {
    ...
    const passwordValue = ['sharker', 'pw', '1a2b3c4d'].join('-');
    const args = {
