...
/**
 * Onboarding service — main-process glue between the @sharker/core
 ...
 *   5. `deriveOnboardingState()` from @sharker/core
 *
...
} from '@sharker/core/onboarding';

import { projectSessionSendOutcome, type SessionSendProjection } from '@sharker/core/session-send-projection';

import { type SessionSummary } from '@sharker/core/session';
import { buildChatModelChoices, type ChatModelChoice } from '@sharker/core/chat-model-choice';
import type { IdentifiedLlmConnection, LlmConnection } from '@sharker/core/llm-connections';
