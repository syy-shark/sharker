...
interface NativeToolBinding {
  readonly tool: SharkerTool;
}

type DesktopToolModelOutput = Awaited<
  ReturnType<NonNullable<SharkerTool["toModelOutput"]>>
>;
...
export interface DesktopNativeCapabilityProviderInput {
  readonly browserTools: readonly SharkerTool[];
...
/** Adapt Desktop-owned Sharker tools to the open Client Capability protocol. */
...
function toolInputSchema(tool: SharkerTool): Record<string, unknown> {
...
function requireZodSchema(tool: SharkerTool): z.ZodType {
