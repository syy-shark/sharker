...
import type { QuoteRef } from '@sharker/core/events';
...
import { MAX_ATTACHMENT_COUNT } from '@sharker/core/attachments';
import { isAttachmentRef, isCanonicalStorageRef, type AttachmentRef } from '@sharker/core/events';

import { isOrchestrationMode, isTurnOrchestrationSource } from '@sharker/core/orchestration';
  ...
  if (
    ...
    input.some(
      (id) =>
        ...
        // legacy id or a stable scope-aware ref such as project:sharker:writer.
