...
import { AstryxLocaleProvider, LocaleProvider } from '@sharker/ui';
import { sharkerTheme } from '../src/renderer/astryx-theme/sharker';

const PALETTE_LABELS: Record<string, string> = {
  default: 'Default',
};

const withSharkerRoot: Decorator = (Story, context) => {
  ...
  if (context.title.startsWith('Product/')) {
    return (
      <Theme theme={sharkerTheme} mode={colorScheme}>
...
const preview: Preview = {
  ...
  globalTypes: {
    ...
    palette: {
      description: 'Sharker palette token set',
      toolbar: {
        icon: 'paintbrush',
