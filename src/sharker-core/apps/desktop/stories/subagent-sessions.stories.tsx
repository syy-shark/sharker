...
const PROJECT_NAME = 'sharker-agent';
...
/**
 * Hosted under `.sharker-turn` so product hover paint applies:
...
function ParentShell() {
  ...
  return (
    <div style={shell.root} data-sharker-contract="subagent-session-layout">
        ...
        <div style={shell.plate}>
          <div style={shell.stream}>
            <ChatMessageList>
              ...
              <ChatMessage sender="assistant" name="Sharker">
                <ChatMessageBubble>
