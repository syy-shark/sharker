...
import type { SearchErrorReason, SearchResult } from '@sharker/core/search';
import { SearchModal } from '@sharker/ui';
import {
  Download,
  FolderOpen,
  MessageSquare,
...
export const SearchModalResults: Story = {
  ...
  play: async ({ canvasElement }) => {
    await enterQuery(canvasElement, '[data-sharker-contract="search-modal"] input', 'benchmark');
  },
};
