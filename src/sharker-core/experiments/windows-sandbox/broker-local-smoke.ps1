...
$manifestPath = Join-Path $env:RUNNER_TEMP "sharker-windows-broker-local-$PID.json"
$digestInput = Join-Path $env:RUNNER_TEMP "sharker-windows-local-digest-$PID.json"
$launch = @{
  version = 1
