...
# Sharker documentation

This page is the authority map for Sharker documentation. Code and contract tests remain the final authority when documentation disagrees with the implementation.
