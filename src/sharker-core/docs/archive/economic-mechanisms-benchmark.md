...
Tracking issue: [#481](https://github.com/sharker-agent/sharker-agent/issues/481) ·
Slice: [#578](https://github.com/sharker-agent/sharker-agent/issues/578)
...
```bash
npm run build --workspace @sharker/runtime
...
SHARKER_CONTEXT_STALE_TOOL_RESULT_PRUNE=on \
SHARKER_CONTEXT_MAX_HISTORY_ESTIMATED_TOKENS=6000 \
SHARKER_CONTEXT_ARCHIVE_RETRIEVAL=on SHARKER_CONTEXT_ARCHIVE_RETRIEVAL_MODE=eager \
SHARKER_CONTEXT_SYNTHESIS_CACHE=on SHARKER_CONTEXT_SYNTHESIS_CACHE_MODE=read_write
```
