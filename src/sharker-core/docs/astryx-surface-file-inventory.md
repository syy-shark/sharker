...
| `apps/desktop/src/renderer/sharker-tokens.css` | styles | n/a (css) | aligned — no off-rhythm control heights flagged | aligned |
...
| `packages/ui/src/sharker-wordmark.tsx` | ui-composition | none | aligned — no raw controls; no Astryx JSX usage | aligned |
