...
import type { CuAction } from '@sharker/core/computer-use';
import { buildComputerUseTools } from '@sharker/runtime/computer-use-tools';
import { parseObservationText } from '@sharker/runtime/test-only/observation-text-reader';
...
// element action — the whole accessibility path, the only one Sharker dispatches
