...
export class McpClientManager {
  ...
  constructor(options: McpClientManagerOptions = {}) {
    ...
    this.clientName = options.clientName ?? 'sharker';
...
/** The shared secret-location plan (@sharker/core/mcp-secrets) is the single
    ...
    { method: 'GET', headers: { accept: 'text/event-stream, application/json' } },
    {
      ...
      body: JSON.stringify({
        ...
        params: {
          ...
          capabilities: {},
          clientInfo: { name: 'sharker-challenge-probe', version: '0' },
        },
      }),
    },
  ];
