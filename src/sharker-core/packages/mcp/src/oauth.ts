...
import type { McpOAuthConfig } from '@sharker/core/mcp';
 ...
 * token request. */
const BACKGROUND_REDIRECT_URL = 'http://127.0.0.1/sharker-mcp-oauth-noninteractive';
...
export class McpOAuthProvider implements OAuthClientProvider {
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      ...
      client_uri: 'https://github.com/sharker-agent/sharker-agent',
      software_id: 'sharker-desktop',
