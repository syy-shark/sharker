...
// reproduced here is the part that reaches markdown — the `.sharker-turn` wrapper
// and the assistant bubble. Nothing in the markdown rhythm keys on `.sharker-turn`
...
export const TranscriptTurn: Story = {
  render: () => (
    <ProseFrame>
      <div className="sharker-turn">
        <ChatMessageBubble variant="ghost" width="100%" className="sharker-chat-message-bubble sharker-chat-message-bubble-assistant">
          <Markdown
            density="compact"
            text={[
              '## 改动思路',
