...
export function SkillInspector(props: {
  ...
  if (updatePreview) {
    return (
      <VStack className="sharker-skill-inspector" gap={4} role="group" aria-label={copy.review.ariaLabel}>
        <VStack gap={2}>
        ...
        <div className="sharker-skill-governance-summary">
        ...
        {updatePreview.skill.managedUpdateStatus === 'local_modified' && (
          <p className="sharker-skill-governance-warning">
            {copy.review.warning}
          </p>
        )}
        <div className="sharker-skill-diff-grid">
          <div>
  ...
  return (
    <VStack className="sharker-skill-inspector" gap={4}>
      <VStack gap={2}>
