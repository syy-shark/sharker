...
export function SandboxBoundaryPrompt({
  ...
  return (
    <section
      className="sharker-composer-interaction sharker-sandbox-boundary-prompt composer"
      aria-labelledby={titleId}
    >
      <div className="sharker-composer-interaction-inner sharker-sandbox-boundary-prompt-inner">
        <div className="sharker-sandbox-boundary-copy">
          <h2 id={titleId}>{copy.title}</h2>
          <p>{request.justification}</p>
        </div>
        <ul className="sharker-sandbox-boundary-scopes">
          {entries.map((entry) => (
        ...
        <div className="sharker-sandbox-boundary-actions">
          <Button
            ref={rejectButtonRef}
            variant="secondary"
