...
export function SessionContextLayer(props: {
  ...
  if (props.goal) {
    ...
    contextItems.push({
      key: 'goal',
      element: (
        <div className="sharker-session-context__goal">
          <StatusDot
  ...
  if (props.revision) {
    ...
    contextItems.push({
      key: 'revision',
      element: (
        <div className="sharker-session-context__revision">
          <Text type="supporting" hasTabularNumbers>
  ...
  return (
    <LayoutHeader
      ...
      className="sharker-session-context"
      data-session-context-layer="true"
      data-has-goal={props.goal ? 'true' : undefined}
    >
      <div className="sharker-session-context__inner">
        ...
        <div className="sharker-session-context__lineage">
          {props.goal ? (
            <Tooltip content={props.goal.condition}>
              <div className="sharker-session-context__goal-description">
            ...
            <Breadcrumbs
              ...
              variant="supporting"
              className="sharker-session-context__breadcrumbs"
            ...
            >
              <BreadcrumbItem
                onClick={props.onBranchNavigate
                  ...
                  : undefined}
              >
                <span className="sharker-session-context__breadcrumb-label">
        ...
        {contextItems.length > 0 && (
          <div className="sharker-session-context__cluster">
            <OverflowList
              gap={1}
              minVisibleItems={1}
              collapseFrom="end"
            ...
            >
              {contextItems.map((item) => (
                <div key={item.key} className="sharker-session-context__item">
                  {item.element}
                </div>
              ))}
            </OverflowList>
