...
export { SharkerUriContext } from './markdown.js';
export * from './sharker-uri.js';
...
// Sharker-owned product assets and compositions remain public only where they do
// not duplicate a published Astryx component authority.
export * from './bot-brand.js';
export * from './bot-brand-logo.js';
export * from './sharker-wordmark.js';
...
// @sharker/ui surface intact; the mechanical atom cut follows separately.
export {
  Button,
  MoreMenu,
  type MoreMenuProps,
