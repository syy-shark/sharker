...
export function syncUiLocaleDocument(
  ...
  root.setAttribute('data-sharker-locale', locale);
  if (override) {
    root.setAttribute('data-sharker-e2e-fixture-locale', override);
  } else {
    root.removeAttribute('data-sharker-e2e-fixture-locale');
  }
}
