 ...
 * `@sharker/ui` (consumed by the renderer's main.tsx, OnboardingHero,
...
export type { UiLocale } from '@sharker/core/ui-locale';
 ...
 *      universally relevant — the chips read as "Sharker is only for
 *      programmers".
 *
