...
export function QuoteRefChip(props: {
  ...
  return (
    <span
      className={cn(
        'sharker-quote-chip',
        expanded ? 'sharker-quote-chip-expanded' : 'sharker-quote-chip-collapsed',
        props.onRemove ? 'sharker-quote-chip-removable' : 'sharker-quote-chip-readonly',
        props.className,
      )}
      title={expanded ? undefined : full}
    >
      <TextQuote
        className={cn('sharker-quote-chip-icon', expanded && 'sharker-quote-chip-icon-expanded')}
        aria-hidden="true"
      />
      <Button
        type="button"
        ...
        label={a11yLabel}
        className={cn(
          'sharker-quote-chip-text',
          expanded && 'sharker-quote-chip-text-expanded',
        )}
      ...
      >
        <span
          ref={measureRef}
          className={cn(
            'sharker-quote-chip-text-body',
            !expanded && 'sharker-quote-chip-text-clipped',
          )}
        >
          {label ? <span className="sharker-quote-chip-label">{label} </span> : null}
          {displayText}
        </span>
      </Button>
      {props.onRemove ? (
        <IconButton
          ...
          className="sharker-quote-chip-remove"
