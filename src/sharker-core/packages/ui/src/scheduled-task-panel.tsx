...
import type { ScheduledTask, ScheduledTaskStatus } from '@sharker/core/scheduled-task';
import {
  generalizedErrorMessage,
  generalizedErrorMessageChinese,
} from '@sharker/core/redaction';
import {
  ...
  return (
    <>
      <ModulePage
        ...
        inspectorAutoSaveId="sharker-scheduled-task-inspector"
        ...
        actions={
          <>
            ...
            <DropdownMenu
              ...
              className="sharker-scheduled-task-page-menu"
            >
              <DropdownMenuItem
      ...
      >
        {taskView === 'tasks' ? (
          <div className="sharker-module-page-panel" ref={rowsContainerRef} {...rovingRows}>
            ...
            {normalizedListQuery && (
              <div className="sharker-scheduled-task-search-summary" role="status" aria-live="polite">
            ...
            {props.tasks.length === 0 ? (
              ...
              (<List density="balanced" hasDividers className="sharker-module-page-rows" aria-label={copy.page.listAriaLabel}>
                {sortedTasks.map((task) => {
                  ...
                  <ListItem
                    ...
                    endContent={task.nextFireAt !== null ? (
                      <Text type="supporting" color="secondary" className="sharker-scheduled-task-countdown">
          ...
          <div className="sharker-module-page-panel">
            {visibleRunEntries.length === 0 ? (
              ...
              <List density="balanced" hasDividers className="sharker-module-page-rows" aria-label={copy.page.runsAriaLabel}>
