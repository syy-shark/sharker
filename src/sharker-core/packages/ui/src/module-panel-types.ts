...
import type { CreateScheduledTaskInput, ScheduledTaskEffect, UpdateScheduledTaskInput } from '@sharker/core/scheduled-task';
...
export interface SkillEntry {
  ...
  source?: 'sharker' | 'agents' | 'legacy' | 'custom';
  contextStatus?:
    | 'advertised'
    | 'disabled'
    | 'invalid'
 ...
 * `@sharker/ui` independent of desktop preload globals — the renderer wires a
