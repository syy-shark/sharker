 ...
 * not re-export them (they are internal to the `@sharker/ui` Composer surface).
 *
    ...
    <>
      ...
      {props.groups.map((group) => (
        <div role="group" aria-label={group.heading} key={group.connectionSlug}>
          <div className="sharker-model-menu-group-heading" aria-hidden="true">
            {group.heading}
          </div>
...
export function ThinkingLevelSelector(props: {
  ...
  return (
    <DropdownMenu
      placement="above"
      hasChevron={false}
      className="sharker-composer-quiet-menu"
      button={{
        label: currentLabel,
        variant: 'ghost',
        size: 'sm',
        ...
        className: 'sharker-thinking-level-selector',
    ...
    <>
      <DropdownMenu
        ...
        button={{
          ...
          tooltip: title,
          className: 'sharker-model-switcher-trigger',
          'aria-label': copy.switchAriaLabel,
        }}
      >
        {announceWarning ? (
          <div className="sharker-model-switch-notice" aria-hidden="true">
      ...
      <span
        className="sharker-visually-hidden sharker-model-switch-announcement"
        role="status"
        aria-live="polite"
        aria-atomic="true"
      >
  ...
  return (
    <DropdownMenu
      ...
      button={{
        ...
        className: 'sharker-new-chat-model-selector',
 ...
 * chevron); otherwise it is plain inert text. Shares the `.sharker-composer-model-chip`
...
export function ModelChipStatic(props: {
  ...
  return (
    <span className="sharker-composer-model-chip" title={props.label}>
      <span className="sharker-composer-model-chip-text">{props.label}</span>
      {props.showUnavailableStatus !== false ? (
        <span className="sharker-composer-model-status" aria-hidden="true" />
      ) : null}
    </span>
  );
}
