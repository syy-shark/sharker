...
/**
 * Sharker's deterministic fixture contract is product-owned. Astryx handles the
...
const FROZEN_HOST_SELECTOR = '[data-sharker-e2e-fixture="true"],[data-sharker-reduced-motion="true"]';
 ...
 * with descendant selectors (`[data-sharker-reduced-motion="true"] *`), so a host
...
export function isTimeDrivenMotionEnabled(within?: Element | null): boolean {
  ...
  if (root.dataset.sharkerE2eFixture === 'true' || root.dataset.sharkerReducedMotion === 'true') return false;
