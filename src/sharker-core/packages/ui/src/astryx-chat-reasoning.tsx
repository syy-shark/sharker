 ...
 * canary core peer even though this release is the stable 0.1.9 source. Sharker
  ...
  return (
    ...
    >
      <div
        ...
        className="sharker-activity-card-header x78zum5 x6s0dn4 x1s4dlld x1ypdohk x87ps6o xjwf9q1 x13f7esw"
      >
      ...
      <div className={isExpanded ? 'xrvj5dj xb0j27v x1tu4anv' : 'xrvj5dj xihq33y xb0j27v'}>
        <div className="xb3r6kr x2lwn1j">
          {/* Product class on the reasoning body: the official component's
              ...
              collapses every newline in the thinking text. Sharker restores the
              pre-wrap reading contract on this class — see
              `.sharker-chat-reasoning-content` in styles.css. */}
          <div className="sharker-chat-reasoning-content x1xye8es x1f43n9v x141an7d x1ltkj2j x9ynric xv1l7n4">{children}</div>
        </div>
      </div>
    </div>
  );
