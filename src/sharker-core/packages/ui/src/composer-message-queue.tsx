...
import type { MessageQueueEntryProjection } from '@sharker/core/events';
...
export const ComposerMessageQueue = memo(function ComposerMessageQueue(
  ...
  return (
    <div
      className="sharker-composer-queue"
      role="region"
      aria-label={copy.queuedMessagesAriaLabel(entries.length)}
    >
      <List className="sharker-composer-queue-list" density="compact">
        {entries.map((entry) => {
          ...
          return (
            ...
            >
              ...
              label={editing ? (
                <textarea
                  autoFocus
                  className="sharker-composer-queue-edit"
                ...
                <span className="sharker-composer-queue-text">
              ...
              startContent={entry.placement === 'next_turn' ? (
                <span
                  className="sharker-composer-queue-grip"
              ...
              endContent={(
                <span className="sharker-composer-queue-actions">
                  {editing ? (
                    <>
                      <IconButton
                        variant="ghost"
