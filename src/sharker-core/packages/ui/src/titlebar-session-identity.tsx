...
export function TitlebarSessionIdentity(props: {
  ...
  useEffect(() => {
    ...
    trailRef.current
      ?.querySelector('.sharker-titlebar-identity__segment--session')
      ?.closest('button')
      ?.focus();
  }, [renaming]);
  ...
  return (
    <div
      className="sharker-titlebar-identity"
      data-sharker-contract="titlebar-identity"
      ref={trailRef}
    >
      ...
      <Breadcrumbs
        ...
        className="sharker-titlebar-identity__breadcrumbs"
      ...
      >
        ...
        {props.project ? (
          <BreadcrumbItem onClick={props.project.onOpenFolder}>
            <span
              className="sharker-titlebar-identity__segment"
            ...
            {props.project.onOpenFolder ? (
              <span className="sharker-visually-hidden">
        ...
        {renaming ? (
          <BreadcrumbItem isCurrent={false}>
            <InlineRenameInput
              className="sharker-titlebar-identity__rename-input"
          ...
          <BreadcrumbItem isCurrent>
            <span className="sharker-titlebar-identity__segment sharker-titlebar-identity__segment--session">
              {props.sessionName}
            </span>
          </BreadcrumbItem>
        ) : (
          ...
          <BreadcrumbItem isCurrent={false} onClick={() => setRenaming(true)}>
            <span
              className="sharker-titlebar-identity__segment sharker-titlebar-identity__segment--session"
              title={copy.sessions.renameAriaLabel}
            >
              {props.sessionName}
            </span>
            <span className="sharker-visually-hidden">{copy.sessions.renameAriaLabel}</span>
          </BreadcrumbItem>
        )}
      </Breadcrumbs>
      {props.action ? (
        <Tooltip content={props.action.label}>
          <IconButton
            className="sharker-titlebar-identity__action"
