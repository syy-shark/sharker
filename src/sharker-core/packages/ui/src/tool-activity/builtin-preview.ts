...
/**
 * Re-export the shared quiet-panel formatting from `@sharker/core` (#1065).
 *
 * `formatToolInvocationLine` and `formatQuietJsonValue` are pure functions
 * extracted from this module into `@sharker/core` so the CLI/TUI can consume
...
} from '@sharker/core/tool-quiet-preview';
...
export function formatQuietJsonValue(
  value: unknown,
  locale: UiLocale,
): import('@sharker/core/tool-quiet-preview').QuietPreview {
