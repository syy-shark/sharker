...
export function SessionSidebarNav() {
  ...
  return (
    <SideNavSection title={copy.mainLabel} isHeaderHidden className="sharker-session-panel-top">
      <SideNavItem
        label={copy.newTask}
        icon={SquarePen}
        size="md"
        onClick={props.onNew}
        endContent={<kbd className="sharker-nav-kbd" aria-hidden="true">⌘ N</kbd>}
      />
      {props.workHubEntry ? (
        <SideNavItem
...
export function SessionSidebarFooter() {
  ...
  return (
    <SideNavSection title={copy.settings} isHeaderHidden className="sharker-session-panel-footer">
      <div className="sharker-sidebar-footer-row">
        <div className="sharker-sidebar-footer-row-primary">
          <SideNavItem
            label={copy.settings}
            icon={Settings}
            size="md"
        ...
        {updateAction && (
          <Tooltip content={updateAction.label}>
            <IconButton
              className="sharker-sidebar-update-button"
