...
function renderMermaid(
  ...
  const task = renderQueue.then(async () => {
    ...
    const id = `sharker-mermaid-${++diagramSequence}`;
...
export function MermaidDiagram(props: {
  ...
  const className = `sharker-markdown-code sharker-markdown-code-${props.density}`;
  if (state.status === 'rendered') {
    ...
    const renderDiagram = (isExpanded: boolean, showContent: boolean) => (
      <figure
        className={`${className} sharker-mermaid-diagram${isExpanded ? ' sharker-mermaid-diagram-expanded' : ''}`}
        data-sharker-contract="mermaid"
        data-sharker-mermaid-state="rendered"
        data-sharker-mermaid-zoom={zoom.toFixed(2)}
        data-sharker-mermaid-layout={viewportLayout ? 'ready' : 'measuring'}
        aria-label={copy.mermaidDiagram}
      >
        <Toolbar
          className="sharker-mermaid-toolbar"
          label={copy.mermaidToolbar}
          size="sm"
          startContent={<span className="sharker-mermaid-title">{copy.mermaidDiagram}</span>}
          endContent={(
            <div className="sharker-mermaid-actions">
              <div className="sharker-mermaid-zoom-actions">
                <IconButton
                  variant="ghost"
                ...
                />
                <output
                  className="sharker-mermaid-zoom-level"
        ...
        {showContent && <div
          ref={viewportRef}
          className="sharker-mermaid-viewport"
          data-sharker-mermaid-panning={panning ? 'true' : 'false'}
          data-sharker-mermaid-pannable={pannableAxis}
        ...
        {showContent && <Collapsible
          className="sharker-mermaid-source"
    ...
    return (
      <>
        ...
        <Dialog
          className="sharker-mermaid-dialog"
          isOpen={expanded}
  ...
  return (
    <div
      className={`${className} sharker-mermaid-fallback`}
      data-sharker-contract="mermaid"
      data-sharker-mermaid-state={state.status}
    >
      <CodeBlock
        code={props.code}
        language="mermaid"
        ...
        isCollapsible
      />
      <div className="sharker-mermaid-fallback-actions">
        <span className="sharker-mermaid-status" role="status">
          {message}
        </span>
