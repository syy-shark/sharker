  ...
  return (
    <DropdownMenu
      ...
      button={{
        ...
        className: 'sharker-workspace-picker',
        endContent: picker.hostBadge ? (
          <span className="sharker-workspace-picker-host-badge">
    ...
    >
      {picker.groups.length > 0 ? <div className="sharker-workspace-picker-scroll">
        {picker.groups.map((group) => {
          ...
          return (
            <div
              ...
              className="sharker-workspace-picker-group"
            >
              <div className="sharker-workspace-picker-group-label">
              ...
              return (
                <DropdownMenuItem
                  ...
                  endContent={missing
                    ? (
                        <span className="sharker-workspace-picker-status">
      ...
      {picker.retry ? (
        <div role="group" className="sharker-workspace-picker-actions">
          <DropdownMenuItem
