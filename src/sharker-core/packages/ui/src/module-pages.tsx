...
function ModulePageFallback(props: { label: string; message: string }) {
  return (
    <section className="sharker-main detailPane sharker-module-main agents-chat-panel" data-page-shell="layout" aria-label={props.label}>
...
function ModulePanelFallback(props: { message: string }) {
  return (
    <div className="sharker-lazy-fallback" data-surface="module">
...
export function ScheduledTasksPage(props: {
  ...
  return (
    <section className="sharker-main detailPane sharker-module-main agents-chat-panel" data-page-shell="layout" data-module="scheduled-tasks" aria-label={label}>
...
export function DailyReviewPage(props: {
  ...
  return (
    <section className="sharker-main detailPane sharker-module-main agents-chat-panel" data-page-shell="layout" data-module="daily-review" aria-label={label}>
      {props.bridge ? (
        ...
        (<ModulePage
          title={label}
          toolbar={props.hubHeader?.badge ? <div className="sharker-module-page-bar">{props.hubHeader.badge}</div> : undefined}
        >
