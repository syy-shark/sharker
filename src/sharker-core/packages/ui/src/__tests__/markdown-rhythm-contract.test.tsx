 ...
 *    in Sharker only inside selectors, so an Astryx rename kills every rule at
...
describe('transcript markdown rhythm', () => {
  it('emits the DOM hooks the rhythm table selects on', () => {
    ...
    assert.match(
      ...
      'the `data-sharker-contract="markdown"` wrapper is gone. Every rule in the rhythm table ' +
