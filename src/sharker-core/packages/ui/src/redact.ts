...
/**
 * Re-export the shared display-layer redactor from `@sharker/core` (#1065).
 *
 ...
 * The backend has its own separate redactor (`@sharker/core/redaction.ts`)
...
} from '@sharker/core/display-redaction';
