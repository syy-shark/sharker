...
const TOKEN_START = '\uE000SHARKER_MATH:';
const TOKEN_END = '\uE001';
const TOKEN_PATTERN = /\uE000SHARKER_MATH:([012]):([0-9a-f]+)\uE001/g;
const LITERAL_TOKEN_PATTERN = /^\uE000SHARKER_MATH:[012]:[0-9a-f]+\uE001/;
  ...
  render: (match, key) => {
    ...
    return (
      <span
        key={key}
        className={
          displayMode ? 'sharker-math sharker-math-display' : 'sharker-math sharker-math-inline'
        }
