...
//   `.sharker-module-main-header` hero) is retired: 技能 / MCP / 定时任务 /
...
export interface PageHeaderProps {
   ...
   * positioning class (e.g. `sharker-module-main-actions`, `sharker-scheduled-task-top-actions`)
  ...
  className?: string;
  /**
   * Class for the title+subtitle content column (e.g. `sharker-scheduled-task-heading`).
...
export function PageHeader({
  ...
  const heading = (
    <Title
      ...
      className="sharker-page-header-title"
    >
      {title}
    </Title>
  );
  const titleRow =
    badge != null || headingRowClassName ? (
      <div
        ...
        className={cn('sharker-page-header-heading-row', headingRowClassName)}
      >
        {heading}
  ...
  const content = (
    <div
      ...
      className={cn('sharker-page-header-content', contentClassName)}
    >
      {eyebrow != null ? (
        <p data-slot="page-header-eyebrow" className="sharker-page-header-eyebrow">
          {eyebrow}
        </p>
      ) : null}
      {titleRow}
      {subtitle != null ? (
        <p
          ...
          className={cn('sharker-page-header-subtitle', subtitleClassName)}
        >
          {subtitle}
        </p>
      ) : null}
