...
const TONE_VALUE_CLASS: Record<StatTileTone, string> = {
  neutral: '',
  info: 'sharker-stat-tile-value-info',
  success: 'sharker-stat-tile-value-success',
  warning: 'sharker-stat-tile-value-warning',
  destructive: 'sharker-stat-tile-value-destructive',
};

const TONE_BORDER_CLASS: Record<StatTileTone, string> = {
  neutral: '',
  info: 'sharker-stat-tile-border-info',
  success: 'sharker-stat-tile-border-success',
  warning: 'sharker-stat-tile-border-warning',
  destructive: 'sharker-stat-tile-border-destructive',
};
  ...
  return (
    <Tag
      className={cn(
        'sharker-stat-tile',
        emphasis === 'outline'
          ? 'sharker-stat-tile-outline'
          : 'sharker-stat-tile-filled',
        emphasis === 'outline' ? TONE_BORDER_CLASS[effectiveTone] : '',
        isEmptyCount ? 'sharker-stat-tile-empty' : '',
        className,
      )}
      data-slot="stat-tile"
    ...
    >
      <span
        className={cn(
          'sharker-stat-tile-value',
          emphasis === 'outline' ? 'sharker-stat-tile-value-outline' : 'sharker-stat-tile-value-filled',
      ...
      <span
        className="sharker-stat-tile-label"
      ...
      {detail != null && (
        <span
          className="sharker-stat-tile-detail"
