...
export function SessionListPanel() {
  ...
  const groupingSwitch = onViewModeChange && !collapsed ? (
    <div className="sharker-session-grouping-switch">
      <SegmentedControl
        value={viewMode}
  ...
  return (
    ...
    //
    // The width itself comes from `--sharker-sidenav-width`, which AppShell
    ...
    <div className="sharker-sidenav-motion">
      <SideNav
        handleRef={chrome.collapseHandleRef}
        className="sharker-session-panel agents-sidebar"
