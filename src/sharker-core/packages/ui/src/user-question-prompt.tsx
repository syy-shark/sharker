...
import type { UserQuestionRequestEvent } from '@sharker/core/events';
...
export function UserQuestionPrompt(props: {
  ...
  return (
    <section
      className="sharker-composer-interaction sharker-user-question-prompt composer"
      role="region"
      aria-labelledby={titleId}
    >
      <div className="sharker-composer-interaction-inner agents-parchment-paper-surface">
        <header className="sharker-interaction-header">
          <div className="sharker-interaction-title-row">
            <h2 className="sharker-interaction-title" id={titleId}>{question.question}</h2>
            <span className="sharker-question-progress">{questionIndex + 1} / {props.request.questions.length}</span>
          </div>
        </header>

        <div className="sharker-question-options">
          <RadioList
          ...
          {draft?.kind === 'other' ? (
            <div className="sharker-question-other-answer">
              <TextInput
        ...
        <footer className="sharker-interaction-actions sharker-question-actions">
          <Button
            variant="ghost"
          ...
          <Button
            variant="primary"
            className="sharker-question-submit"
