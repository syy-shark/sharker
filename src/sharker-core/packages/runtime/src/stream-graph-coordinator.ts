...
import type { AgentGraphClientProjectionStore } from '@sharker/core/agent-graph-client-projection';
import type { AgentGraphIntentClaim } from '@sharker/core/agent-graph-control';
import type { AgentGraphEpochBinding, AgentGraphEpochStore } from '@sharker/core/agent-graph-epoch';
import type { AgentGraphEpochPage } from '@sharker/core/agent-graph-epoch';
import type {
  AgentGraphScheduleControlStore,
  AgentGraphSelectedResultInput,
  AgentGraphScheduleUpdate,
} from '@sharker/core/agent-graph-schedule';
import type { AgentGraphTimelineMetadataStore } from '@sharker/core/agent-graph-timeline';
import type { AgentGraphOperatorProvision } from '@sharker/core/agent-graph-topology';
import type { AgentRunStore } from '@sharker/core/agent-run';
...
} from '@sharker/core/agent-graph-client-projection';
...
export class AgentGraphCoordinator {
   ...
   */
  async toolsForSession(rootSessionId: string): Promise<SharkerTool[]> {
