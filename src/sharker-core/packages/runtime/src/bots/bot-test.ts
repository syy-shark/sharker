...
import { type BotChannelSettings, type BotProvider } from '@sharker/core/bot-chat-settings';
...
/**
 * PR1197 review (P1-4): Feishu and Lark share one Sharker channel but live on
