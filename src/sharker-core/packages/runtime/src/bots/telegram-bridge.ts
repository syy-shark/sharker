...
import type { BotAttachmentKind } from '@sharker/core/bot-events';
 ...
 * the parent message was deleted — preserving Sharker's response rather
 ...
 * path (non-text payload that Sharker cannot interpret yet).
 *
...
export class TelegramBotBridge extends BaseBotAdapter implements SendCapable {
   ...
   * "Sharker is typing…" affordance shows in the client while the agent
