...
export const SCHEDULED_TASK_NATIVE_EFFECT_SERVICE_ID = 'sharker_scheduled_task_native_effect';
...
export function buildScheduledTaskTool(deps: { authority: ScheduledTaskToolAuthority }): SharkerTool {
  return {
