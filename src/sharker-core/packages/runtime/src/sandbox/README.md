...
[issue #2142](https://github.com/apache/sharker/issues/2142) and specified by the
...
`@sharker/core` owns the platform-neutral boundary language:
...
`@sharker/runtime` owns platform transformation:
...
- Unrestricted, disabled, and external profiles do not add a Sharker-managed local sandbox.
...
| Surface                                                                             | macOS                                                     | Linux                                                     | Windows                                                                                                     | When no Sharker-managed sandbox is required                                                                                          |
| ----------------------------------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
...
- `PermissionProfile.External` means file-system isolation is supplied by the environment; Sharker does not stack a local platform sandbox in the current implementation.
