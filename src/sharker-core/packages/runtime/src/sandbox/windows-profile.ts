...
import type { FileSystemSandboxEntry, PermissionProfile } from '@sharker/core/permission-profile';
import { canonicalWindowsPath as coreCanonicalWindowsPath } from '@sharker/core/windows-path';
