...
import type { AgentRunHeader, AgentRunStore } from '@sharker/core/agent-run';
import {
...
import { DEFAULT_TOOL_MODE, type ToolMode } from '@sharker/core/tool-mode';
import {
  AgentRun,
...
export class RuntimeKernel implements RuntimeKernelLike {
  ...
  private async resolveSubagentActivation(
    header: SessionHeader,
  ): Promise<{ systemPrompt: string; tools: SharkerTool[]; shell?: TurnShellPlan } | undefined> {
