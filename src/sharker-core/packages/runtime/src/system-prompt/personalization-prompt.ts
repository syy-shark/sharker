...
import type { PersonalizationSettings, PersonalizationSettingsWarning } from '@sharker/core/settings';

/**
 * User personalization prompt fragment (display name + assistant tone).
 *
 * Pure sanitizer + prompt builder; types come from @sharker/core. Moved here from
