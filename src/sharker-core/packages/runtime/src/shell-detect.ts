...
import type { ShellSettings } from '@sharker/core/settings';
...
const POWERSHELL_COMMAND_ENV = '__SHARKER_RUNTIME_POWERSHELL_COMMAND';
...
function buildPowerShellCommand(
  ...
  const invokeCommand =
    `$__sharkerCommandText = [Environment]::GetEnvironmentVariable('${POWERSHELL_COMMAND_ENV}')\n` +
