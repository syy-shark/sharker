...
export interface SkillManifest {
  ...
  /** Sharker's bundled-catalog extension. It is not model-facing runtime authority. */
  category?: string;
}
...
const SUPPORTED_SKILL_FIELDS = new Set([
  ...
  'compatibility',
  'metadata',
  // Sharker's bundled catalog owns this display-only extension.
  'category',
]);
 ...
 *
 * Required discovery metadata and safety-relevant Sharker extensions fail
 * closed. Cosmetic/spec-compatibility findings remain warnings so Sharker can
