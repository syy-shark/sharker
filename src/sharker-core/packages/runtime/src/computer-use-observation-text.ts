...
//    assistant turn by convention stated in prose; Sharker binds actions to a
...
//    at all. Sharker's is disabled by default rather than absent, and the frames
 ...
 * applications were operable, and Sharker has no pixel fallback to reach one it
