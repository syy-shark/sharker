...
export function buildAgentGraphSupervisorTools(
  ...
  SharkerTool<ViewAgentGraphToolInput, ViewAgentGraphToolResult>,
  SharkerTool<UpdateAgentGraphToolInput, UpdateAgentGraphToolResult>,
  SharkerTool<YieldAgentGraphToolInput, YieldAgentGraphToolResult>,
] {
  const graphId = requireIdentity(input.graphId, 'graph id');
  const viewTool: SharkerTool<ViewAgentGraphToolInput, ViewAgentGraphToolResult> = {
  ...
  const updateTool: SharkerTool<UpdateAgentGraphToolInput, UpdateAgentGraphToolResult> = {
  ...
  const yieldTool: SharkerTool<YieldAgentGraphToolInput, YieldAgentGraphToolResult> = {
