...
import { z } from 'zod';
import { resolveHostedWebSearchCapability } from '@sharker/core/model-web-search';
import type { HostedWebSearchAdapter } from '@sharker/core/model-web-search';
import type { RuntimeExecutionConnection } from '@sharker/core/llm-connections';
import type { WebSearchSettings } from '@sharker/core/web-search';
...
export function routeWebSearchTools(input: {
  ...
  let selected: SharkerTool | undefined;
