...
import type { AgentBackend, BackendSendInput, BackendStopMode } from '@sharker/core/backend-types';
...
function memoryStore(): SessionStore {
  let header: SessionHeader = {
    id: SESSION_ID,
    workspaceRoot: '/tmp/sharker-runtime-kernel-interaction',
    cwd: '/tmp/sharker-runtime-kernel-interaction',
    createdAt: 1,
