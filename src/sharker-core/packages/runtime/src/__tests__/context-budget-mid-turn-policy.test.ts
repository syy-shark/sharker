...
test('context policy is independent of process environment overrides', () => {
  const overrides = {
    SHARKER_CONTEXT_BUDGET: 'off',
    SHARKER_CONTEXT_HISTORY_COMPACT: 'off',
    SHARKER_CONTEXT_HISTORY_COMPACT_HIGH_WATER_NAME: 'custom-high-water',
    SHARKER_CONTEXT_HISTORY_COMPACT_MID_TURN: 'off',
    SHARKER_CONTEXT_HISTORY_COMPACT_MID_TURN_TAIL_EVENTS: '99',
    SHARKER_CONTEXT_HISTORY_COMPACT_RESERVE_TOKENS: '1',
    SHARKER_CONTEXT_STALE_TOOL_RESULT_PRUNE: 'off',
    SHARKER_CONTEXT_STALE_TOOL_RESULT_MAX_TOKENS: '1',
    SHARKER_CONTEXT_STALE_TOOL_RESULT_MIN_RECENT_TURNS: '99',
    SHARKER_CONTEXT_ACTIVE_TOOL_RESULT_PRUNE: 'off',
    SHARKER_CONTEXT_ACTIVE_TOOL_RESULT_MAX_ESTIMATED_TOKENS: '1',
    SHARKER_CONTEXT_ACTIVE_TOOL_RESULT_MIN_STEP_NUMBER: '99',
    SHARKER_CONTEXT_ACTIVE_TOOL_RESULT_MIN_SUPERSEDED_TOKENS: '1',
  } as const;
...
describe('declared relay context window', () => {
  ...
  test('a declared context window holds on any provider', () => {
    ...
    // one — Sharker has no other way to learn it — is not confined to relays: it
