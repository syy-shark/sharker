...
describe('macOS executable dependency resolution', () => {
  ...
  test('resolves rpath, loader_path, and executable_path dependencies recursively', async () => {
    const executable = '/Applications/Sharker.app/Contents/Resources/bin/rg';
    const library = '/Applications/Sharker.app/Contents/Resources/lib/libsearch.dylib';
    const loaderLibrary = '/Applications/Sharker.app/Contents/Resources/lib/libloader.dylib';
    const executableLibrary = '/Applications/Sharker.app/Contents/Resources/bin/libexec.dylib';
    const fixture = dependencyFixture({
      files: new Map([
        [executable, executable],
        [library, library],
    ...
    assert.deepEqual(result.runtimeReadableRoots, [
      '/Applications/Sharker.app/Contents/Resources/lib',
      '/Applications/Sharker.app/Contents/Resources/bin',
    ]);
  });
