...
import { CU_TOOL_ACTION_TYPES, type CuAction } from '@sharker/core/computer-use';
...
function ctx(signal?: AbortSignal, overrides: Partial<SharkerToolContext> = {}): SharkerToolContext {
  return {
    sessionId: 's1',
    turnId: 't1',
    cwd: '/tmp',
...
describe('buildComputerUseTools — the `sharker_computer` SharkerTool', () => {
