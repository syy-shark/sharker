...
import { lookupModelProviderOverride, openAiAdapterApiProtocol } from '@sharker/core/model-metadata';
import {
  PROVIDER_REGISTRY,
...
function reasoningReplayCell(
  ...
  // opaquely; except for the stateless Agent Plan contract above, the Sharker
