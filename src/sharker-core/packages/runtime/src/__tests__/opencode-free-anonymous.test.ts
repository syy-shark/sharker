 ...
 *
 * opencode-free is Sharker's zero-credential default. Its free-tier access works
...
import { getAIModel } from '@sharker/runtime/model-factory';

import { testConnection } from '@sharker/runtime/test-connection';
