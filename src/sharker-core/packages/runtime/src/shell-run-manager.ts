...
import { encodeTerminalInputActions } from '@sharker/core/terminal-input';
import {
...
import { TerminalMouseInputRejectedError } from '@sharker/core/terminal-mouse-input';
import { type ShellRunSnapshotResult, type ShellRunUpdate } from '@sharker/core/events';
 ...
 * shaped `sharker://runtime/<something>`, so a mistyped path segment gets all the
...
const BACKGROUND_TASK_REF_HELP =
  ...
  'background task started — the form is sharker://runtime/background-tasks/<id>.';
