...
import { isShellRunId, SHELL_RUN_ID_MAX_CHARS, type ShellRunStore } from '@sharker/core/shell-run';
...
export const SHELL_RUN_RESOURCE_PREFIX = 'sharker://runtime/background-tasks';
