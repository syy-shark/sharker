...
const contextBrand = Symbol.for('sharker.plugin-kernel.context');
const effectMeta = Symbol('sharker.plugin-kernel.effect-meta');
...
export class Context {
  ...
  static readonly filter = Symbol('sharker.plugin-kernel.filter');
