 ...
 *
 * NOTE: imports the new `@sharker/core/runtime-event` subpath. The steward
...
import { formatAttachmentResourceRef } from '@sharker/core/attachments';
import type { AttachmentRef, QuoteRef } from '@sharker/core/events';
 ...
 * Sharker-namespaced providerOptions entry — provider adapters only read their
 ...
 * message.
 */
const STEERING_PROVIDER_OPTIONS_NAMESPACE = 'sharker';
