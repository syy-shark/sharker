...
import { z } from 'zod';
import type { UserQuestion, UserQuestionResult } from '@sharker/core/user-question';
...
export function buildAskUserQuestionTool(): SharkerTool<
...
> {
  return {
    ...
    impl: ({ questions }, context) => {
      ...
      // guard answers only an embedder that assembles its own SharkerToolContext.
