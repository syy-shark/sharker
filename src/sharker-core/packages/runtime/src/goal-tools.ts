...
export function buildGoalTools(deps: GoalToolsDeps): SharkerTool[] {
  return [
...
function buildGoalSetTool(deps: GoalToolsDeps): SharkerTool<
  {
    condition: string;
...
function buildGoalClearTool(deps: GoalToolsDeps): SharkerTool<Record<string, never>, string> {
  return {
...
function buildGoalPauseTool(deps: GoalToolsDeps): SharkerTool<Record<string, never>, string> {
  return {
...
function buildGoalResumeTool(deps: GoalToolsDeps): SharkerTool<Record<string, never>, string> {
  return {
...
function buildGoalStatusTool(deps: GoalToolsDeps): SharkerTool<Record<string, never>, string> {
  return {
