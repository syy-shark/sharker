...
import type { AssistantStepContentKind, StoredMessage, TurnStatus } from '@sharker/core/session';
import type { RuntimeEvent, RuntimeEventStatus } from '@sharker/core/runtime-event';
import type { ToolActivityKind, ToolResultContent } from '@sharker/core/events';
...
import { TOOL_ACTIVITY_KINDS, normalizeMessageContent } from '@sharker/core/events';
