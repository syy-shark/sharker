...
// more than one license. Sharker took them from opencode's edit.ts
...
//                Sharker carries opencode's result and collects spans rather than
...
//
// Sharker keeps the three distinctly-reachable full-span matchers (line-trimmed,
...
//
// Scope: the adapted material only. The rest of this file is Sharker source under
