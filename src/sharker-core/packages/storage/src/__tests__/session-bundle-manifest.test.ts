...
const canonicalManifestText =
  ...
  `"compressionLevel":3,"name":"sharker-session-bundle","version":1},` +
  ...
  `"application/vnd.sharker.session-state-identity+json;version=1","path":"state-identity.json"}}`;
