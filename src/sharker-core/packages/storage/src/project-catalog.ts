...
import type { ProjectLocation, ProjectRecord } from '@sharker/core/project';
...
export type { ProjectLocation, ProjectRecord } from '@sharker/core/project';
...
class SqliteProjectCatalog implements ProjectCatalog {
   ...
   *
   * The serial queue only orders callers within a process, so a second Sharker
