...
// opencode sessions as Sharker Sessions.
//
...
import { externalSessionMatchesQuery } from '@sharker/core/external-session';
import type {
  ExternalSharkerSession,
  ExternalSessionAdapter,
  ExternalSessionQuery,
  ExternalSessionSummary,
} from '@sharker/core/external-session';
import { sanitizeForeignTitle } from '@sharker/core/foreign-session';
...
export class OpenCodeSessionAdapter implements ExternalSessionAdapter {
  ...
  async readSession(sessionId: string): Promise<ExternalSharkerSession> {
...
/**
 * Turns one opencode conversation into Sharker messages.
 *
