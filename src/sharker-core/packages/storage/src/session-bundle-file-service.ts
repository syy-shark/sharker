...
const HYDRATION_STAGING_MARKER = '.sharker-session-bundle-staging-';
const HYDRATION_OWNERSHIP_SUFFIX = '.owner.json';
const HYDRATION_OWNERSHIP_KIND = 'sharker-session-bundle-hydration-staging' as const;
const HYDRATION_OWNERSHIP_BINDING_KIND = 'sharker-session-bundle-hydration-staging-binding' as const;
const HYDRATION_OWNERSHIP_ANCHOR = '.sharker-session-bundle-owner';
...
const PACK_TEMP_MARKER = '.sharker-session-bundle-pack-';
const PUBLICATION_LOCK_MARKER = '.sharker-session-bundle-publish-';
