...
import type { ExternalAgentId, ExternalSessionAdapterRegistry } from '@sharker/core/external-session';
...
/**
 * Converts no formats itself. The selected adapter returns Sharker StoredMessages;
