...
It needs a working Docker daemon and outbound network, so it is opt-in:
    ...
    SHARKER_EVAL_EGRESS_NAMESPACE_TEST=1 python3 harbor/test_cell_egress_namespace.py
"""
...
PROXY_IMAGE = "sharker-eval-egress-proxy:12.2.3"
MAIN_IMAGE = "sharker-eval-egress-namespace-main:test"
SIDECAR_IMAGE = "sharker-eval-egress-namespace-sidecar:test"
PROJECT = "sharker-eval-egress-namespace-test"
PROXY_HOST = "sharker-eval-mitmproxy"
SIDECAR = "harbor-docker-egress-control-sidecar"
OUTSIDER = "sharker-eval-outside-the-namespace"
BOUNDED = "sharker-eval-bounded-capability"
CA_PATH = "/opt/sharker-egress/mitmproxy-ca-cert.pem"
BUILD_TIMEOUT_S = 900
...
@unittest.skipUnless(
    os.environ.get("SHARKER_EVAL_EGRESS_NAMESPACE_TEST") == "1",
    "set SHARKER_EVAL_EGRESS_NAMESPACE_TEST=1 to run the Docker cell namespace test",
)
class CellEgressNamespaceTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.workdir = Path(tempfile.mkdtemp(prefix="sharker-eval-egress-namespace-"))
    ...
    def run_compose(
        ...
        *,
        ...
        return subprocess.run(
            ...
            env={**os.environ, "SHARKER_EVAL_NETWORK_POLICY_PATH": str(NETWORK_POLICY)},
            capture_output=True,
            text=True,
            check=check,
            timeout=timeout,
    ...
    def test_subject_sees_only_the_ca_certificate(self) -> None:
        listed = self.exec_main(["ls", "--almost-all", "/opt/sharker-egress"])
