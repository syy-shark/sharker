...
export function parseExperimentSpec(value: unknown): ExperimentSpec {
  ...
  if (root.schemaVersion !== 'sharker.eval.v1') throw new Error('unsupported experiment schema');
