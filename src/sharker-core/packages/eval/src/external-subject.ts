...
> {
  ...
  try {
    ...
    if (
      checkpoint.schemaVersion !== 'sharker.external_provider_usage.v2' ||
...
function decodeResult(stdout: string): {
  ...
  if (
    result.schemaVersion !== 'sharker.external_subject_result.v1' &&
    result.schemaVersion !== 'sharker.external_subject_result.v2'
  )
