...
import { CONNECTION_CATALOG_MAX_CONNECTIONS } from '@sharker/core/runtime-policy';
import { serializeOAuthSubscriptionTokens } from '@sharker/runtime/subscription-credentials';
import { type ConnectionEffectFetchTransport } from '@sharker/runtime/network/scoped-fetch-transport';
import { type ConnectionTestEffectOutcome } from '@sharker/runtime/connection-effect-outcome';
import {
...
async function withFixture(
  ...
  const base = await mkdtemp(join(tmpdir(), 'sharker-connection-effects-'));
