...
export const RUNTIME_HOST_LAUNCH_OWNER_LEASE_FD_ENV = 'SHARKER_RUNTIME_HOST_LAUNCH_OWNER_LEASE_FD';
export const RUNTIME_HOST_LAUNCH_OWNER_GUARD_ENV = 'SHARKER_RUNTIME_HOST_LAUNCH_OWNER_GUARD';
export const RUNTIME_HOST_LAUNCH_OWNER_CLIENT_ID_ENV = 'SHARKER_RUNTIME_HOST_LAUNCH_OWNER_CLIENT_ID';
