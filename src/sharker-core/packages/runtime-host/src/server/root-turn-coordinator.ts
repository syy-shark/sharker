...
import type { BackendStopMode } from '@sharker/core/backend-types';
import type { AgentRunHeader, RootExecutionDescriptor } from '@sharker/core/agent-run';
import {
...
import { isWorkHubCoordinationSessionId, type SessionHeader } from '@sharker/core/session';
import { resolveEffectiveOrchestration } from '@sharker/core/orchestration';
import {
...
import { RuntimeRegenerateTurnError, type SessionManager } from '@sharker/runtime/session-manager';
import { RuntimeOwnerCleanupError } from '@sharker/runtime/runtime-kernel';
import {
  parseSkillInvocationTokens,
  type PreparedSkillInvocationMessage,
} from '@sharker/runtime/skill-invocation';
import { skillInvocationInlineReferences } from '@sharker/runtime/skill-invocation-receipt';
import {
  type RuntimeContinuation,
  type SafeBoundaryContinuationPlan,
} from '@sharker/runtime/runtime-resume';
import {
