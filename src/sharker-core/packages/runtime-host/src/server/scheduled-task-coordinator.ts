...
import { botDisplayLabel } from '@sharker/core/bot-events';
import { isBotDeliveryProvider } from '@sharker/core/bot-chat-settings';
import { messageContentsEqual } from '@sharker/core/events';
import { type ScheduledTask, type ScheduledTaskExecutionTemplate } from '@sharker/core/scheduled-task';
...
} from '@sharker/storage/scheduled-task-store';
import {
...
export class HostScheduledTaskCoordinator implements ScheduledTaskToolAuthority {
  ...
  readonly modelTool: SharkerTool;
  readonly #store: InteractiveScheduledTaskStoreWriter;
  readonly #sessions: ScheduledTaskSessions;
  readonly #runtime: ScheduledTaskRuntime;
  readonly #root: ScheduledTaskRoot;
