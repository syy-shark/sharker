...
import { inspectAgentRunDocument, inspectSessionDocument } from '@sharker/runtime/execution-inspect';
import { projectSessionTrace } from '@sharker/runtime/session-trace-projection';
import {
  type AgentRunInspectDocument,
  type SessionInspectDocument,
} from '@sharker/core/execution-inspect';
import {
