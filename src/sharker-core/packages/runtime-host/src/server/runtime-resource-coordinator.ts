...
import type { ShellRunSnapshotResult, ShellRunUpdate, ToolResultContent } from '@sharker/core/events';
...
import { type ShellRunLauncher } from '@sharker/runtime/shell-tools';
import { defaultShellPlan, ShellPreferenceError, type ShellPlan } from '@sharker/runtime/shell-detect';
import { isSessionNotFoundError } from '@sharker/storage/execution-stores';
import {
