...
import type { InteractiveLongTermMemoryWriter } from '@sharker/storage/long-term-memory-store';
...
import { type HistoryCompactCheckpoint } from '@sharker/runtime/history-compact-checkpoint';
