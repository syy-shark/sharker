...
import { MAX_ATTACHMENT_BYTES } from '@sharker/core/attachments';
import {
  createToolResultArchiveCapability,
  type ToolResultArchiveCapability,
  type ToolResultArchiveRecorderInput,
} from '@sharker/runtime/tool-result-archive-capability';
import { isPathInside } from '@sharker/runtime/path-containment';
import { stableToolResultArchiveArtifactId } from '@sharker/runtime/tool-result-archive';
import { type ToolArtifactRecorderInput } from '@sharker/runtime/tool-artifacts';
import {
  type ToolResultArchiveReaderInput,
  type ToolResultArchiveReadResult,
} from '@sharker/runtime/context-budget';
import { type ToolResultArchiveResourceReadInput } from '@sharker/runtime/tool-result-archive-resource';
import type { InteractiveArtifactStoreWriter } from '@sharker/storage/artifact-stores';
