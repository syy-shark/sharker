...
import type { RootExecutionDescriptor } from '@sharker/core/agent-run';
import { normalizeMessageContent, type MessageContent } from '@sharker/core/events';
...
import { parseSkillInvocationTokens } from '@sharker/runtime/skill-invocation';
import { type SessionManager } from '@sharker/runtime/session-manager';
import type { ExecutionStoresWriter } from '@sharker/storage/execution-stores';
