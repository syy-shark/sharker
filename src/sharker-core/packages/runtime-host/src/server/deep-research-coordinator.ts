...
import { projectDeepResearchEvents, type DeepResearchRun } from '@sharker/core/deep-research-run';
import { projectDeepResearchClientProgress } from '@sharker/core/deep-research-client-progress';
import { isDeepResearchSession } from '@sharker/core/deep-research';
import { buildDeepResearchTools } from '@sharker/runtime/deep-research-tools';
...
} from '@sharker/storage/deep-research-authority';
import {
...
export class HostDeepResearchCoordinator {
  ...
  toolsForSession(sessionId: string): readonly SharkerTool[] {
