...
import { isModelExplicitlyUnsupportedForChat } from '@sharker/core/model-catalog';
import { parseRequestHeaders, type RuntimePolicy } from '@sharker/core/runtime-policy';
import type { RuntimeEvent } from '@sharker/core/runtime-event';
import type { SessionHeader } from '@sharker/core/session';
import type { ModelCallKind } from '@sharker/core/usage-stats/types';
import {
  buildPricingLookup,
  llmCallUsageFields,
  recordLlmCallStrict,
} from '@sharker/runtime/telemetry';
import { buildProviderOptions, getAIModel } from '@sharker/runtime/model-factory';
import { buildSessionRecapMessages } from '@sharker/runtime/session-recap';
import {
...
} from '@sharker/runtime/tool-free-model-call';
import { modelUsesAnthropicMessages } from '@sharker/runtime/model-runtime';
import { type BackendFactoryContext } from '@sharker/runtime/session-manager';
import { type GoalEvaluatorResource } from '@sharker/runtime/goal-evaluator';
import { type ModelMessage } from '@sharker/runtime/model-protocol';
import {
  memoryExtractionMaxOutputTokens,
  type MemoryExtractionSourceSnapshot,
} from '@sharker/runtime/memory-extraction';
