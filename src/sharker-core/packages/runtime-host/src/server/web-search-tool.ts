...
import { buildWebSearchTool } from '@sharker/runtime/web-search-tool';
import {
  createProxiedFetchTransport,
  type ProxiedFetchProxy,
  type ProxiedFetchTransport,
} from '@sharker/runtime/network/scoped-fetch-transport';
import { queryTavily } from '@sharker/runtime/tavily-search';
import { type SharkerTool } from '@sharker/runtime/tool-runtime';
import type { WebSearchResponse } from '@sharker/core/web-search';
import type { RuntimePolicy } from '@sharker/core/runtime-policy';
import type {
...
export function createHostWebSearchTool(input: HostWebSearchServiceInput): SharkerTool {
  return createHostWebSearchToolFromService(createHostWebSearchService(input));
}

export function createHostWebSearchToolFromService(service: HostWebSearchService): SharkerTool {
