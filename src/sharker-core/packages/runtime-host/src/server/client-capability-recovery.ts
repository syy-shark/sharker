...
import { compatibilityToolResultProjection } from '@sharker/runtime/durable-tool-result-projection';
import type { ExecutionRuntimeEventWriter } from '@sharker/storage/execution-stores';
