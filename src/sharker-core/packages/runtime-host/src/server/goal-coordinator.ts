...
} from '@sharker/core/goal';
import { userFacingText, type StoredMessage } from '@sharker/core/session';
import {
...
} from '@sharker/runtime/goal-continuation';
import {
  GoalManager,
  ...
  type GoalState,
} from '@sharker/runtime/goal-state';
import { buildGoalTools } from '@sharker/runtime/goal-tools';
...
import { isSessionNotFoundError, type ExecutionStoresWriter } from '@sharker/storage/execution-stores';
import {
