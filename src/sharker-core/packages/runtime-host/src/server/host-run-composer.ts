...
import type { AiSdkBackendInput, SystemPromptContext } from '@sharker/runtime/ai-sdk-backend';
...
import type { ToolAvailabilityConfig } from '@sharker/runtime/tool-availability';
