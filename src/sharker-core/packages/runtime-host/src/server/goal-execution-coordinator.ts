...
import type { GoalCheckpoint, GoalControlLease } from '@sharker/runtime/goal-state';
import type { GoalTurnAdmission, GoalTurnOutcome } from '@sharker/runtime/goal-continuation';
