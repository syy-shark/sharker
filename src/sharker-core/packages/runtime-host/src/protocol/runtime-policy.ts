...
import { normalizeRelayModelProfiles, type RelayModelProfile } from '@sharker/core/model-thinking';
...
export type { RelayModelProfile, RelayModelProfiles } from '@sharker/core/model-thinking';
