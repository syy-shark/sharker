...
import { TOOL_ACTIVITY_KINDS, TOOL_OUTPUT_DELTA_MAX_CHARS } from '@sharker/core/events';
import type { SandboxBoundaryFailureSignal, ToolResultPreviewContent } from '@sharker/core/events';
import { decodeToolResultPreviewContent } from '@sharker/core/tool-result-preview';
import type { ToolActivityKind } from '@sharker/core/events';
import type { SessionStatus } from '@sharker/core/session';
import {
  assertExactKeys,
  requireCount,
  requireEntityId,
 ...
 * the call during the live window. Sized to fit `@sharker/core`
...
export type SessionToolEvent =
  | (SessionToolEventIdentity & {
      ...
      intent?: string;
      /**
       * Bounded, redacted subset of the call args (see `@sharker/core`
