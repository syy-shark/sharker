...
import { readStateRootCompositionBinding } from '@sharker/storage/state-root-composition';
...
export const ELECTION_DEADLINE_MS_ENV_VAR = 'SHARKER_RUNTIME_HOST_ELECTION_DEADLINE_MS';
