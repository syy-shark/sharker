...
// output, i.e. below the input box. The Sharker TUI pins the input at the bottom
...
// selected index while keeping that selected row inside Sharker's live viewport.
//
...
export interface SharkerAutocompleteArrangementInput {
  lines: string[];
...
export interface SharkerAutocompleteArrangementResult {
  lines: string[];
  autocompleteSlotRows: number;
  editorRows: number;
}
...
export function arrangeAutocompleteAboveEditor(
  input: SharkerAutocompleteArrangementInput,
): SharkerAutocompleteArrangementResult {
...
export class SharkerAutocompleteAboveEditorComponent implements Component {
...
interface SharkerAutocompleteSections {
  autocompleteLines: string[];
  editorLines: string[];
}

function splitTrailingAutocomplete(lines: string[]): SharkerAutocompleteSections {
