...
import type { UserQuestionOption } from '@sharker/core/user-question';
...
import {
  ...
  type UiLocale,
} from '@sharker/core/ui-locale';
import type { InvocableSkillEntry } from '@sharker/runtime/skill-invocation';
import { PROVIDER_DEFAULTS, type ModelInfo, type ProviderType } from '@sharker/core/llm-connections';
import type {
  ModelChoice,
  OnboardingFailure,
...
export class SharkerAutocompleteProvider implements AutocompleteProvider {
  private readonly fileProvider: CombinedAutocompleteProvider | undefined;
  private readonly slashCommands: readonly SharkerSlashCommandMetadata[];
  ...
  constructor(
    ...
    slashCommands: readonly SharkerSlashCommandMetadata[],
...
export interface SharkerSlashCommandMetadata {
  name: string;
  description: string;
}
...
export interface SharkerSlashCommand extends SharkerSlashCommandMetadata {
  /**
