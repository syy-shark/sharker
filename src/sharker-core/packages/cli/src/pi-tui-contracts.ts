...
import type { ForeignSessionDigest, ForeignSessionSummary } from '@sharker/core/foreign-session';
import type { ModelInfo, ProviderType } from '@sharker/core/llm-connections';
import type { ThinkingLevel } from '@sharker/core/model-thinking';
import type { ConnectionOnboardingTarget } from '@sharker/core/runtime-policy';
import type {
...
import type { SharkerPiTuiTurnActivity } from './pi-tui-turn.js';
...
export interface SharkerOnboardingSurface {
...
export interface SharkerForeignSessionReader {
...
export type SharkerPiTuiTurnActivitySurface = SharkerPiTuiTurnActivity;
