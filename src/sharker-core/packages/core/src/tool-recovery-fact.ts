...
export const TOOL_RECONCILE_RESULT_FACT_KIND = 'sharker.tool.reconcile_result' as const;
export const TOOL_RECOVERY_DECISION_FACT_KIND = 'sharker.tool.recovery_decision' as const;
