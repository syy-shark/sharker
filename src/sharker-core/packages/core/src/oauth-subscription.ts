 ...
 *
 * This module is `@sharker/core` so it is consumable from both main
...
export type SubscriptionActionFailureReason =
  ...
  // Sharker's own kill-switch (legal / product gate) per kenji
  // `1da909d5`. UI copy must reflect "Sharker has not enabled this
