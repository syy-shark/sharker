 ...
 *
 * Sharker doesn't bill users, so this is UX correctness, not financial
 ...
 * any provider key Sharker ships (`anthropic:claude-sonnet-4-5` =
 ...
 *   - `>= 0` (0 is legitimate for free tier; Sharker doesn't impose
