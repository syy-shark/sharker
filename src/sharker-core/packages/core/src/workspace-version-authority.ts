...
export const WORKSPACE_EPOCH_OPENED_FACT_KIND = 'sharker.workspace.epoch_opened' as const;
export const WORKSPACE_BASELINE_ACCEPTED_FACT_KIND = 'sharker.workspace.baseline_accepted' as const;
export const WORKSPACE_VERSION_ACCEPTED_FACT_KIND = 'sharker.workspace.version_accepted' as const;
...
export const WORKSPACE_AUTHORITY_SESSION_ID = 'sharker_workspace_authority' as const;
