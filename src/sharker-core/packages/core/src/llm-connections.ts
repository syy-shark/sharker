 ...
 * account. Everything else Sharker holds is an observation: a `/models` response
 ...
 * than a refusal Sharker synthesizes from a list it may not even have (#1584),
 ...
 *     `chrome-extension:`, `app:`, `sharker:`, custom).
