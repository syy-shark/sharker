...
/**
 * Stable reference to provider execution policy implemented by `@sharker/runtime`.
...
type OpenAiCompatibleRuntimeAdapter = OpenAiCompatibleRuntimeAdapterBase &
  (
    ...
    | {
        responses?: never;
        /** Explicitly delegates concrete execution policy to `@sharker/runtime`. */
...
export interface ProviderDefaults {
  ...
  /**
   * Sharker used to offer this provider and no longer does. The entry stays
...
// opencode-free is Sharker's first-class free anonymous default. It shares the
...
/**
 * A provider Sharker used to offer and no longer does. Read this rather than
