...
export const AGENT_RUN_INSPECT_DOCUMENT_VERSION = 'sharker.agent_run_inspect.v1' as const;
export const SESSION_INSPECT_DOCUMENT_VERSION = 'sharker.session_inspect.v1' as const;
