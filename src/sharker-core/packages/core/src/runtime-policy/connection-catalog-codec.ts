 ...
 * Sharker does not — a model newer than the bundled snapshot, or any model on a
 ...
 * reason. A table carrying them on another provider describes a request Sharker
