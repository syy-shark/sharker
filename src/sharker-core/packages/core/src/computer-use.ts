 ...
 * `computer-use-schema-parity.test.ts` (@sharker/runtime, which can import the
...
/**
 * Every action name the `sharker_computer` tool accepts, in wire order.
 *
 ...
 * transcript said it had called `sharker_computer` with `approvalClass`,
