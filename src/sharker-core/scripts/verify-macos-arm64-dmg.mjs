...
const expectedAppId = 'com.sharker.desktop';
...
export async function smokePackagedFilesystemWorker(
  ...
  const content = 'sharker-filesystem-worker-ok';
...
export async function verifyPackagedMacApp(
  ...
  assertSingleArchitecture(executableArchitectures.stdout, 'Sharker executable');
...
export async function verifyMacosArm64Dmg(
  ...
  const copiedApp = join(temporaryDirectory, 'Sharker.app');
