...
const WINDOWS_DIAGNOSTIC_PATHS_ENV = 'SHARKER_RUNTIME_HOST_DIAGNOSTIC_PATHS';
...
const STORAGE_AUTHORITY_MODULE = 'node_modules/@sharker/storage/dist/root-authority.js';
const REGISTRATION_MODULE = 'node_modules/@sharker/runtime-host/dist/control/registration.js';
const STARTUP_DIAGNOSTIC_MODULE =
  'node_modules/@sharker/runtime-host/dist/control/startup-diagnostic.js';
