...
const pairs = [
  { pkg: '@sharker/core', src: 'packages/core/src', dist: 'packages/core/dist' },
  { pkg: '@sharker/storage', src: 'packages/storage/src', dist: 'packages/storage/dist' },
  { pkg: '@sharker/runtime', src: 'packages/runtime/src', dist: 'packages/runtime/dist' },
  {
    pkg: '@sharker/runtime-host',
    src: 'packages/runtime-host/src',
    dist: 'packages/runtime-host/dist',
  },
  { pkg: '@sharker/ui', src: 'packages/ui/src', dist: 'packages/ui/dist' },
  { pkg: '@sharker/desktop:main', src: 'apps/desktop/src/main', dist: 'apps/desktop/dist/main' },
  {
    pkg: '@sharker/desktop:preload',
    src: 'apps/desktop/src/preload',
    dist: 'apps/desktop/dist/preload',
  },
  {
    pkg: '@sharker/desktop:renderer',
