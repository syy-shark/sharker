---
name: sharker-architecture-docs
description: Draft, restructure, translate, or review bilingual Chinese-English architecture documentation for the Sharker Agent backend. Use when Codex works on Sharker technical narratives, component or mechanism explanations, architecture decisions, system flows, engineering guides, or documentation quality checks and needs blog-like clarity without losing architectural precision. Do not use it to impose a fixed topic list or information architecture unless the user asks for one.
---
<!--
...
- Use stable terms. Do not alternate among synonyms for variety when they represent the same Sharker concept.
