...
| `PersonalizationSettings.tsx` / `.css` | 个性化：Enable memories（官方默认关）+ Use memories / Generate memories、Pragmatic / Friendly / None、个人 `~/.sharker/AGENTS.md`（对标 Codex Settings → Personalization；单对话 `/memories` 覆盖） |
