...
| `GeneralSettings.tsx` | 通用：Follow-up behavior（Queue / Steer）、Enter 发送、`file_opener` 默认打开位置、Show context window usage 用量环（官方默认关）、/review 交付与审查模型（对标 Codex `review_model`）、Prevent sleep while running |
