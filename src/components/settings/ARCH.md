...
| `McpSettings.tsx` / `.css` | MCP servers：列表、开关、Add server（STDIO / Streamable HTTP）、Restart（对标 Codex Settings → MCP servers / learn.chatgpt.com/docs/extend/mcp；不假装 OAuth） |
