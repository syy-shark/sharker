 ...
 * 增长尾最后一块（含段落软换行、嵌套项内引用 / 围栏、围栏 / 标题 / HR / 表闭合后的项后缀、闭合并栏后再起表 / 标题 / 引用、标题后另起的项内表、引用内围栏闭合后的后续段、缩进代码后另起的标题、缩进代码 / 脚注续行 / 引用内换行后的列表项）只重解析增长段；前面的标题 / 段落保持不动（对标 Codex #39061 / #34045）。
