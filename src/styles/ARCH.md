...
- 桌面壳层走 Sharker token；此处 `.glass-*` 只给尚未迁走的设置页原语，见 [docs/ui-style.md](../../docs/ui-style.md)
...
| `sharker-shell.css` | 接入 Sharker 桌面壳层 styles.css（灰底 canvas + 白浮板）；补 Electron 拖拽、设置页宿主、侧栏顶栏给红绿灯让位 |
| `ARCH.md` | 本层架构说明 |
