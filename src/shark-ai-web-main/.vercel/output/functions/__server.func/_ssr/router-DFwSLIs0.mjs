...
import { f as createRouter, g as createRootRoute, h as createFileRoute, l as Scripts, m as lazyRouteComponent, p as Outlet, u as HeadContent, v as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DFwSLIs0.js
...
var styles_default = "/assets/styles-Q-6Yw4b6.css";
var APP_NAME = "Sharker — AI Assistants That Finish Your Work";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "For work that happens in a browser, an inbox, or a file, hand it off in one sentence. Work at the speed of thought."
			},
			{
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700&family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;1,9..144,500&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-WNTkvakv.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-Dd8HIyYv.mjs");
