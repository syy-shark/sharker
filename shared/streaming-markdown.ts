...
function tryContinueLastCheapProseBlock(
  ...
  if (prevBlocks.length === 1) {
    const grown = continueLastBlockOfType(prevBlocks[0]!, prevNorm, nextText, defs)
