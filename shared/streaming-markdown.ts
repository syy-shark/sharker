...
function tryContinueLastCheapProseBlock(
  ...
  if (suffix.includes(']:') && lastBlock.type !== 'footnotes') return null
  const citedIds =
    lastBlock.type === 'footnotes' && suffix.includes(']:')
