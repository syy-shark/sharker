...
describe('slash commands', () => {
  it('lists changes as a panel command and review as a working-tree review', () => {
    ...
    expect(SLASH_COMMANDS.find((c) => c.name === 'agents')?.description).toBe('Open Subagents')
    expect(SLASH_COMMANDS.find((c) => c.name === 'agent')?.description).toBe('Open Subagents')
    expect(SLASH_COMMANDS.find((c) => c.name === 'subagents')?.description).toBe('Open Subagents')
