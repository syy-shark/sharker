...
| `reveal-in-folder.ts` | 官方 Open in Finder / Open in Explorer / Open in File Manager / Copy path：平台文案、线程项目目录、审查文件绝对路径、侧栏线程菜单项（Open in Finder / Copy as Markdown / Rename / Pin / Unpin / Archive，对标 Codex #13123 / #25646 / #33217 / #29449）、顶栏 Copy 子菜单（Copy working directory / Copy session ID / Copy deeplink / Copy as Markdown，对标 Codex #25201 / #28233）。另有官方 New chat / Find in chat / Search chats / Open command menu / Toggle sidebar / Toggle file tree / Open model picker / Start dictation / Approve request / Decline request 等快捷键文案，以及 Settings 页 General / Appearance / Notifications / Personalization / Suggested prompts / Browser / MCP servers / Profile / Unarchive / Show context window usage / Prevent sleep while running / Share / Keep a chat near your work / Always on top / Open in Popup Window / Edit project / Archive chats / Add folder / Make primary / Fork / Pause / Resume / Edit / Clear / Hand off / Local / Worktree / Create branch here（对标 developers.openai.com/codex/app/settings / learn.chatgpt.com/docs/projects / learn.chatgpt.com/docs/long-running-work / learn.chatgpt.com/docs/environments/git-worktrees / #40832 / #15162）。不接自定义 Open with |
