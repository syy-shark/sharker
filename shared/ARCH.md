...
| `workbench-shortcuts.ts` | 默认工作台快捷键与 `SHORTCUT_CATALOG`（设置页改绑；标题用官方 Open command menu / Toggle sidebar / Toggle bottom panel / Toggle terminal / Toggle file tree / Run environment action 1 / Toggle Activity view / Open model picker / Open project picker / Start dictation 等，对标 developers.openai.com/codex/app/commands 与 #20552）；Search chats 默认不绑、⌘G 留给 Find next；Esc 停止当前回合可改绑；帮助表含输入框 Shift+Tab 切计划、⌘↑⌘↓ / Home / End 跳对话顶底、点对话柱后滚动；浏览器聚焦刷新 / 批注；终端聚焦 ⌘K 清屏判定 |
...
| `reveal-in-folder.ts` | 官方 Open in Finder / Open in Explorer / Open in File Manager / Copy path：平台文案、线程项目目录、审查文件绝对路径、侧栏线程菜单项（Open in Finder / Copy as Markdown / Rename / Pin / Unpin / Archive，对标 Codex #13123 / #25646 / #33217 / #29449）、顶栏 Copy 子菜单（Copy working directory / Copy session ID / Copy deeplink / Copy as Markdown，对标 Codex #25201 / #28233）。另有官方 New chat / Find in chat / Search chats / Open command menu / Toggle sidebar / Toggle file tree / Open model picker / Start dictation 等快捷键文案，以及 Settings 页 General / Appearance / Notifications / Personalization / Suggested prompts / Browser / MCP servers / Share / Keep a chat near your work / Always on top / Open in Popup Window（对标 developers.openai.com/codex/app/settings / #40832 / #15162）。不接自定义 Open with |
