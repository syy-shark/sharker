...
describe('deeplink', () => {
  ...
  it('maps settings paths and unknown settings to the main page', () => {
    ...
    expect(parseDeeplink('sharker://settings/worktree')).toEqual({
      type: 'settings',
      tab: 'worktrees'
    })
    expect(parseDeeplink('sharker://settings/personalization')).toEqual({
      type: 'settings',
      tab: 'personalization'
    })
    expect(parseDeeplink('sharker://settings/personality')).toEqual({
      type: 'settings',
      tab: 'personalization'
    })
    ...
    expect(parseDeeplink('sharker://settings/notify')).toEqual({
      type: 'settings',
      tab: 'notifications'
    })
    ...
    expect(parseDeeplink('sharker://settings/profile')).toEqual({
      type: 'settings',
      tab: 'usage'
    })
    expect(parseDeeplink('sharker://settings/tokens')).toEqual({
      type: 'settings',
      tab: 'usage'
    })
