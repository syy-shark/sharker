...
| `app-menu.ts` | macOS 应用菜单顶层用官方 File / Edit / View / Window / Help（对标 Codex #14450）；应用菜单 About / Hide / Hide Others / Show All / Quit 用官方英文（对标 #28543 About Codex，不发明 Check for Updates / Log Out）、Open settings、File 菜单 New chat / New standalone chat / New window（⌘⇧N，对标 Codex #12773 / #26890，不发明 Quick chat）/ Open folder / Share / Close 以及 Copy as Markdown（对标 Codex Copy as Markdown）；View 用官方 Toggle sidebar / Toggle bottom panel / Open Terminal / Toggle review panel / Open review tab / Toggle File Tree / Open Browser Tab / Focus Browser Address Bar / Reload Browser Page / Find / Previous Chat / Next Chat / Back / Forward / Toggle Full Screen（对标 #20552 / #30659 / #37104 / #26890，不发明 Toggle Pinned Summary / Toggle Side Panel / Zoom In）；Help 用官方 Codex Documentation（打开 developers.openai.com/codex）/ Send Feedback（本机反馈窗，不上传）以及 Open command menu / Open keyboard shortcuts（对标 #26890，不发明 Check for Updates）；Edit 用官方 Undo / Redo / Cut / Copy / Paste / Select All（对标 #26890）；撤销/重做走渲染进程（输入框原生、其它处应用动作）；自定义项 `registerAccelerator: false` |
